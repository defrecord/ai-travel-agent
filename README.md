...
1. Clone the repository:
   ```bash
   git clone https://github.com/defrecord/ai-travel-agent.git
   cd ai-travel-agent
   ```
...
## Community
- [GitHub Discussions](https://github.com/defrecord/ai-travel-agent/discussions)
- [Issue Tracker](https://github.com/defrecord/ai-travel-agent/issues)
